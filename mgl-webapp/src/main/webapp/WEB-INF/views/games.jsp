...
<%@ taglib tagdir="/WEB-INF/tags" prefix="mgl" %>
    ...
    <head>
        ...
        <script src="resources/static/js/GameApp.js" /></script>
        ...
        <div class="container" ng-controller="GameController as ctrl">
            <div class="panel panel-default">
                ...
                <div class="formcontainer">
                    ...
                    <form ng-if="ctrl.game.id" name="gameForm" class="form-horizontal">
                        <input type="hidden" ng-model="ctrl.game.id" />
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label class="col-md-2 control-lable text-light" for="game_name">Name*</label>
                        ...
                        <div class="row">
                            <div class="form-actions floatRight">
                                <button ng-click="ctrl.updateGame()" class="btn btn-primary btn-sm">Update</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <table class="table table-dark table-striped text-light">
                        ...
                        <tbody>
                            <tr ng-repeat="currentGame in ctrl.games">
                                ...
                                <td></td>
                                <td><button class="btn btn-danger btn-sm" ng-click="ctrl.deleteGame(currentGame.id)">Delete</button></td>
                                <td><button class="btn btn-secondary btn-sm" ng-click="ctrl.loadGame(currentGame)">Edit</button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
